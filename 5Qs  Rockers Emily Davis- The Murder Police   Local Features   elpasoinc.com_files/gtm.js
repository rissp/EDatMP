...
"\uff07":"%EF%BC%87","\uff08":"%EF%BC%88","\uff09":"%EF%BC%89","\uff0a":"%EF%BC%8A","\uff0b":"%EF%BC%8B","\uff0c":"%EF%BC%8C","\uff0f":"%EF%BC%8F","\uff1a":"%EF%BC%9A","\uff1b":"%EF%BC%9B","\uff1d":"%EF%BC%9D","\uff1f":"%EF%BC%9F","\uff20":"%EF%BC%A0","\uff3b":"%EF%BC%BB","\uff3d":"%EF%BC%BD"},nc=function(a){return mc[a]};var oc=
/^(?:(?:https?|mailto):|[^&:\/?#]*(?:[\/?#]|$))/i;Vb[14]=function(a){var b=String(a);return oc.test(b)?b.replace(lc,nc):"#zSoyz"};var pc,sc=[],tc=[],uc=[],vc=[],wc=[],xc={},yc,zc,Ac,Bc=function(a){var b=a["function"];if(!b)throw"Error: No function name given for function call.";var c=!!xc[b],d={},e;for(e in a)a.hasOwnProperty(e)&&0===e.indexOf("vtp_")&&(d[c?e:e.substr(4)]=a[e]);return c?xc[b](d):pc(b,d)},Dc=function(a,b,c,d){c=c||[];d=d||ya;var e={},f;for(f in a)a.hasOwnProperty(f)&&(e[f]=Cc(a[f],b,c,d));return e},Cc=function(a,b,c,d){if(Ca(a)){var e;switch(a[0]){case "function_id":return a[1];case "list":e=[];for(var f=1;f<
...
b.vtp_trackType){I={hitType:"social",socialNetwork:String(b.vtp_socialNetwork),socialAction:String(b.vtp_socialAction),socialTarget:String(b.vtp_socialActionTarget)},M(J,I,!1),t("send",I);}else if("TRACK_TRANSACTION"==b.vtp_trackType){}else if("TRACK_TIMING"==b.vtp_trackType){
